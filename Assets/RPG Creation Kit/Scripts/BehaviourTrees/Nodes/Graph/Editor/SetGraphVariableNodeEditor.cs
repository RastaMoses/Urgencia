...
namespace RPGCreationKit.BehaviourTree
{
    ...
    public class SetGraphVariableNodeEditor : BTNodeNodeEditor
    {
        private SetGraphVariableNode setVariableNode;
        ...
        {
            if (setVariableNode == null) setVariableNode = target as SetGraphVariableNode;
