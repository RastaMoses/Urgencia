...
{
    [CustomNodeEditor(typeof(CFloatComparisonNode))]
    public class CFloatComparisonNodeEditor : BTNodeNodeEditor
    {
        private CFloatComparisonNode comparisonNode;

        public override void OnBodyGUI()
        {
            if (comparisonNode == null) comparisonNode = target as CFloatComparisonNode;
            ...
            if (foldout)
            {
                ...
                if (serializedObject.FindProperty("firstUseVariable").boolValue)
                    ...
                    comparisonNode.firstInstantValue = EditorGUILayout.DelayedFloatField("Instant Value:", comparisonNode.firstInstantValue);
                ...
                if (serializedObject.FindProperty("secondUseVariable").boolValue)
                    ...
                    comparisonNode.secondInstantValue = EditorGUILayout.DelayedFloatField("Instant Value:", comparisonNode.secondInstantValue);
