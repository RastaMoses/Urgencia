...
namespace RPGCreationKit.BehaviourTree
{
    ...
    /// </summary>
    [CreateNodeMenu("RPGCK_BehaviourTree/Actions/AI/Get Property", order = 1)]
    [System.Serializable]
    public class AI_GetPropertyNode : BTNode
    {
        ...
        {
            propertyInfo = eAI.GetType().GetProperty(PropertyToGet);
        ...
        public override NodeState Execute(RckAI eAI)
        {
            ...
            storedValueRuntime.SetValue(propertyInfo.GetValue(component));
