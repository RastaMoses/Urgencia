...
{
    public class ConsumableItem_Window : ItemWindow
    {
        ...
        public override void Init(SerializedObject _item)
        {
            ...
            // Set Title
            Texture icon = AssetDatabase.LoadAssetAtPath<Texture>(EditorIconsPath.ConsumableItemWindowIcon);
            GUIContent titleContent = new GUIContent("ConsumableItem", icon);
            ...
            effects = itemObj.FindProperty("effects");
            isConsumable = itemObj.FindProperty("isConsumable");
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.BeginVertical("box", GUILayout.MaxWidth(255f));
            ...
            // Value
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField(new GUIContent("Is Consumable?", "Can this item be consumed by the Player & NPCs?"), GUILayout.ExpandWidth(false));
            EditorGUILayout.PropertyField(isConsumable, GUIContent.none, GUILayout.ExpandWidth(false));
            EditorGUILayout.EndHorizontal();
            ...
            effectsScrollPos =
                EditorGUILayout.BeginScrollView(effectsScrollPos, GUILayout.Height(315f));

            EditorGUILayout.PropertyField(effects, new GUIContent("OnUse Effects:"), true, GUILayout.ExpandHeight(true));
