...
{
    public class MiscItem_Window : ItemWindow
    {
        ...
        SerializedProperty showInPlayerInventory;
        ...
        public override void Init(SerializedObject _item)
        {
            ...
            // Set Title
            Texture icon = AssetDatabase.LoadAssetAtPath<Texture>(EditorIconsPath.MiscItemWindowIcon);
            GUIContent titleContent = new GUIContent("MiscItem", icon);
            ...
            showInPlayerInventory = itemObj.FindProperty("showInPlayerInventory");
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.PropertyField(itemID, GUIContent.none, GUILayout.MaxWidth(120));
            EditorGUILayout.EndHorizontal();
            ...
            EditorGUILayout.PropertyField(itemName, GUIContent.none, GUILayout.MaxWidth(120));
            EditorGUILayout.EndHorizontal();
            ...
            EditorGUILayout.BeginVertical();
            EditorGUILayout.PropertyField(showInPlayerInventory);
            EditorGUILayout.EndVertical();
