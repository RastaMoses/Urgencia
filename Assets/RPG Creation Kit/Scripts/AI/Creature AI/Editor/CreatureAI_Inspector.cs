...
namespace RPGCreationKit.AI
{
    ...
    public class CreatureAI_Inspector : Editor
    {
        RckAI tAI;
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (selected)
            {
                ...
                case 0:
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("toDisableOnDeath"), new GUIContent("To Disable On Death", "GameObjects to disable when this Creature dies, mostly used to make their weapons disappear."));
