...
{
    [CustomEditor(typeof(RckAI))]
    public class RckAI_Inspector : Editor
    {
        RckAI tAI;
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUI.DrawTexture(new Rect(0, 0, EditorGUIUtility.currentViewWidth, 130), _logo, ScaleMode.ScaleToFit, true, 5.0f);
            ...
            { 
                ...
                case 0:
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("enableDebugInEditor"), new GUIContent("Debug Entity", "Enables/disables in-editor debug for this entity."));
                ...
                case 2:
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("dialogueLookAt"), new GUIContent("Rotate Towards?", "If true, the NPC will rotate towards who he is speaking to while in dialogue."));
                ...
                case 3:
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("alwaysCacheMainTargetDuringOffline"), new GUIContent("Always cache target pos?", "If this is true, when in offline mode this entity will ALWAYS follow its main target."));
                ...
                case 6:
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("spellsKnowledge"), new GUIContent("Spells Knowledge:"));

                    //EditorGUILayout.PropertyField(serializedObject.FindProperty("canLoseAggro"), new GUIContent("Can Lose Aggro", ""));
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("isCastingSpell"));
                ...
                case 7:
                    ...
                    if(serializedObject.FindProperty("tickRate").enumValueIndex == 1)
                    {
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("enableDynamicTickRate"));
                        if(serializedObject.FindProperty("enableDynamicTickRate").boolValue)
                            EditorGUILayout.PropertyField(serializedObject.FindProperty("dynamicTickRateSettings"));
                    }
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("btPurposeVarData"), true);
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("purposeState"));
